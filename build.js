...
const pages = [
  { source: 'src/pages/en/index.page.html', output: 'en/index.html', alternateOutput: 'ja/index.html', xDefaultOutput: 'en/index.html', lang: 'en', title: 'Shun Yat Choy (Shinichi)', description: 'Personal website of Shun Yat Choy (Shinichi).', name: 'Shun Yat Choy (Shinichi)', current: 'home', languageHref: '../ja/index.html', languageLabel: '日本語', homeHref: '#top', assetRoot: '../' },
  { source: 'src/pages/en/background.page.html', output: 'en/background.html', alternateOutput: 'ja/background.html', xDefaultOutput: 'en/background.html', lang: 'en', title: 'Background — Shun Yat Choy (Shinichi)', description: 'A summary of Shun Yat (Shinichi) Choy\'s education, work experience, and achievements.', name: 'Shun Yat Choy (Shinichi)', current: 'background', languageHref: '../ja/background.html', languageLabel: '日本語', homeHref: 'index.html', assetRoot: '../' },
  { source: 'src/pages/en/projects.page.html', output: 'en/projects.html', alternateOutput: 'ja/projects.html', xDefaultOutput: 'en/projects.html', lang: 'en', title: 'Research & Projects — Shun Yat Choy (Shinichi)', description: 'An introduction to Shun Yat (Shinichi) Choy\'s research activities and software projects.', name: 'Shun Yat Choy (Shinichi)', current: 'projects', languageHref: '../ja/projects.html', languageLabel: '日本語', homeHref: 'index.html', assetRoot: '../' },
  { source: 'src/pages/ja/index.page.html', output: 'ja/index.html', alternateOutput: 'en/index.html', xDefaultOutput: 'en/index.html', lang: 'ja', title: '蔡 信一', description: '蔡 信一の個人ホームページ。', name: '蔡 信一', current: 'home', languageHref: '../en/index.html', languageLabel: 'English', homeHref: '#top', assetRoot: '../' },
  { source: 'src/pages/ja/background.page.html', output: 'ja/background.html', alternateOutput: 'en/background.html', xDefaultOutput: 'en/background.html', lang: 'ja', title: '経歴 — 蔡 信一', description: '蔡 信一の学歴、職歴、受賞歴。', name: '蔡 信一', current: 'background', languageHref: '../en/background.html', languageLabel: 'English', homeHref: 'index.html', assetRoot: '../' },
  { source: 'src/pages/ja/projects.page.html', output: 'ja/projects.html', alternateOutput: 'en/projects.html', xDefaultOutput: 'en/projects.html', lang: 'ja', title: '研究・作品 — 蔡 信一', description: '蔡 信一の研究活動と作品。', name: '蔡 信一', current: 'projects', languageHref: '../en/projects.html', languageLabel: 'English', homeHref: 'index.html', assetRoot: '../' },
];
const navLabels = {
